...
function Navbar() {
  return (
    <nav className="bg-blue-600 p-4 shadow-md sticky top-0">
      <ul className="flex items-center sm:justify-between justify-evenly max-w-7xl mx-auto px-4 text-white">
        ...
        <div className="flex space-x-4 ml-2">
          <Fragment>
            <li>
              <Link
                to="/login"
                className="bg-white text-blue-600 hover:bg-gray-200 px-3 py-2 rounded-full font-semibold transition-all duration-300 ease-in-out"
              >
                Login
              </Link>
            </li>
